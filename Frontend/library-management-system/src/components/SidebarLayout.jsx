  ...
  return (
    <div className="container-fluid">
      <div className="row">
        {/* Sidebar */}
        <div
          className="col-md-3 col-lg-2 bg-dark text-white d-flex flex-column justify-content-between min-vh-100"
          style={{
            position: "fixed",
            top: 0,
            left: 0,
        ...
        {/* Main Content */}
        <div className="col offset-md-3 offset-lg-2" style={{ marginLeft: "240px", padding: "2rem" }}>
          <Outlet />
        </div>
      </div>
    </div>
